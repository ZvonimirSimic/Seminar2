...
public class AnswerButton : MonoBehaviour
{
    ...
    public void AnswerButtonClicked()
    {
        if (Correct)
        {
            ...
            Debug.Log(transform.parent.parent.parent.parent.parent.parent.parent.GetComponentInChildren<TimeController>().gameObject.name);
            GameObject parentObj = transform.parent.parent.parent.parent.parent.parent.parent.gameObject;
            parentObj.GetComponentInChildren<NextQuestion>().setTime();
            parentObj.GetComponentInChildren<TimeController>().setCorrect();
            parentObj.GetComponentInChildren<AnswerController>().ScoreIncrement();
            _button.image.color = _correctColor;
        }
        else
        {
